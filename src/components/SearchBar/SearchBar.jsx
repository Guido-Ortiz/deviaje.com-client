...
import {
  getFlightsInfo,
  getFlightsInfoToFrom,
  getFlightsInfoToFromExact,
  getFlightsInfoExact,
  setValuesInputs,
  getPassengers,
  ...
  return (
    <div className={s.display}>
      ...
      <FormControl>
        ...
        >
          <FormControlLabel
            value={true}
            control={<Radio />}
            label={t("searchBar.vuelta")}
            sx={{ marginLeft: "10px" }}
          />
          <FormControlLabel
            value={false}
            control={<Radio />}
            label={t("searchBar.ida")}
            sx={{ marginLeft: "1px" }}
          />
        </RadioGroup>
      </FormControl>
      ...
      <FormControlLabel
        ...
        control={<Checkbox checked={check} onChange={handleChangeCheck} />}
        label={t("searchBar.range")}
      />
